        ...
        <main className="flex flex-col items-center justify-center py-10">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center space-y-10 lg:space-y-16">
              ...
              <p className="px-20 lg:px-52 text-center text-xl md:text-2xl max-w-max text-stone-800">"K" is a user-friendly Cover Letter Generator that simplifies the process, allowing you to quickly generate personalized cover letters tailored to each job description, based on your preferences.</p>
